...
namespace RealEstate.Services
{
    ...
    public static class ZillowURI
    {
        ...
        // Home Valuation
        public static readonly Uri baseUri = new Uri ("http://www.zillow.com/webservice/GetDeepSearchResults.htm");
        public static readonly Uri Zest = new Uri("http://www.zillow.com/webservice/GetZestimate.htm");
