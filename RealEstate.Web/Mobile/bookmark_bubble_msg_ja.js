google.bookmarkbubble.Bubble.prototype.msg = {
  ...
  android4: 
    '<img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_ANDROID4_MOBILE_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" /> をタッチし<br />"<b>ブックマーク保存</b>を選択後<br />"<b>追加先</b>"に"<b>ホーム画面</b>"を選択し、この<b>アプリケーションをインストール</b>してください',
  android41: 
    'このページをブックマークへ追加後、保存した<b>ブックマークを長押し</b>し、<b>ショートカットを追加</b>を選択して、この<b>アプリケーションをインストール</b>してください',
  android44: 
    '<img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_ANDROID4_MOBILE_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" /> をタッチし<br />"<b>ホーム画面へ追加</b>を選択し、この<b>アプリケーションをインストール</b>してください',
  blackberry: 
