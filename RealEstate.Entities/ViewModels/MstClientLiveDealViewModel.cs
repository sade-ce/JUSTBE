...
{
    public class MstClientLiveDealViewModel
    {
        public IEnumerable<ClientView> MultipleDealList { get; set; }

        public ClosingDateView ClosingDate { get; set; }
        public StatusPercentage Percentage { get; set; }
        public IEnumerable<utblMstKeyInfoLink> KeyInfoLinkList { get; set; }
        public IEnumerable<DealTimeline> DealTimeline { get; set; }
        public IEnumerable<DealTimeline> CompleletedDealTimeline { get; set; }
        public IEnumerable<DealTimeline> TimelineMissingData { get; set; }

        public IEnumerable<ChartData> ChartData { get; set; }
        public IEnumerable<ClientDoc> ClientDoc { get; set; }
        public IEnumerable<MLSListing> MLSListing { get; set; }
        public MLSListingDetails DisplayListing { get; set; }

        public Root SearchResults { get; set; }
        public utblMstClosingDate utblMstClosingDate { get; set; }
        public MstUserAgentView MstUserAgentView { get; set;}
        public MstUserClientView MstUserClientView { get; set; }
        ...
        public IEnumerable<ClientDealDocumentsView> ClientDealDocumentList { get; set; }
        public IEnumerable<MstAppointmentCalendarModel> AppointmentList { get; set; }
        public BuildingView BuildingView { get; set; }

    }

    public class ClosingDateView
    {
